...
export function MusicPlayer() {
  ...
  return (
    <div className="flex h-auto w-fit items-center gap-4 rounded-md bg-neutral-950 p-2">
      <audio className="hidden" ref={player} />
      <Play
        className="h-auto w-auto text-slate-200"
        onClick={() => {
        ...
        suffix={
          volume == 0 ? (
            <VolumeX
              ...
              className="h-auto w-12 p-1 text-slate-200"
            />
          ) : (
            <Volume2
              onClick={() => {
