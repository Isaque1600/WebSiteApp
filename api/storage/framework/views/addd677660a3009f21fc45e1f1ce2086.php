                    ...
                    <div class="ml-6">
                        ...
                        <p class="mt-2 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            ...
                            <?php if(defined('LARAVEL_START')): ?>
                                Response successfully rendered in <?php echo e(round((microtime(true) - LARAVEL_START) * 1000)); ?>ms.
                            <?php endif; ?>
                        </p>
                    </div>
                </div>
...
<?php /**PATH /var/www/html/php8.3/WebSite/WebSiteApp/api/vendor/laravel/framework/src/Illuminate/Foundation/Configuration/../resources/health-up.blade.php ENDPATH**/ ?>